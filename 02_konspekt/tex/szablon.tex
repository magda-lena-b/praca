...
Procesowanie języka naturalnego jest bardzo szeroką dziedziną data science. Pokrywa gamę zagadnień rozpoczynając od najprostszych typu Podstawowe elementy przygotowywania danych do analiz związanych z przetwarzaniem języka naturalnego to:
\begin{itemize}
...
\bibitem{C} Peter Hancox, \textit{A brief history of Natural Language Processing}, \url{https://www.cs.bham.ac.uk/~pjh/sem1a5/pt1/pt1_history.html}, dostęp 14.05.2020r.
\bibitem{C} National Research University Higher School of Economics, \textit{Natural Language Processing}, \url{https://www.coursera.org/learn/language-processing/home/info}
